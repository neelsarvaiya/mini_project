                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <input type="password" class="form-control" name="password" id="password"
                                        placeholder="Password" data-validation="required strongPassword" value="KIri23@#">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-success w-100" type="submit" name="signup_btn">Sign Up</button>
                                </div>
                            </div>
                        </form>
